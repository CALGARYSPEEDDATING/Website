  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('admin.auth.user.ban',['user'=>$user->id]) }}">
            <select class="form-control" name="period">
                <option value="{{ \Carbon\Carbon::now()->addDays(7) }}">1 Week</option>
                <option value="{{ \Carbon\Carbon::now()->addDays(14) }}">2 Weeks</option>
                <option value="{{ \Carbon\Carbon::now()->addMonths(3) }}">3 Months</option>
                <option value="{{ \Carbon\Carbon::now()->addMonths(6) }}">6 Months</option>
                <option value="{{ \Carbon\Carbon::now()->addMonths(12) }}">1 Year</option>
