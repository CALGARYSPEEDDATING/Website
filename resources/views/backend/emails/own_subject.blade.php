...
@endpush
@section('title', app_name() . 'Email | Own Subject ' )
...
<div class="card">
    ...
    <form method="post" action="{{route('admin.email.postOwnSubject')}}">
            @csrf
        ...
        <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="select_subject" class="col-2 col-form-label">Subject</label>
                <div class="col-9">
