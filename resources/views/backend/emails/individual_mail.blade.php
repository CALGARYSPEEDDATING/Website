...
@endpush
@section('title', app_name() . 'Email | Individual ' )
...
<div class="card">
    <div class="card-body">
        ...
        <!--row-->
        <form method="post" action="{{route('admin.email.postIndividualMail')}}">
            @csrf
            ...
            <div class="form-group row">
                <label for="events" class="col-2 col-form-label">User</label>
                <div class="col-9">
                    <select class="form-control multiple" id="user_select" required name="user_select[]" multiple="multiple">
                        <!-- <option value="">Select User</option> -->
                    </select>
                </div>
            </div>
            <div class="form-group row">
                <label for="description" class="col-2 col-form-label">Message Body</label>
                <div class="col-9">
