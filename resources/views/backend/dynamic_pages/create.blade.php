...
@endpush
@section('title', app_name() . 'Create | Dynamic Page ' )
...
<div class="card">
    <div class="card-body">
        ...
        <!--row-->
        <form method="post" action="{{route('admin.store_dynamic_page')}}">
            @csrf
            <div class="form-group row">
                <label for="page_title" class="col-2 col-form-label">Page Title</label>
                <div class="col-9">
                    <input type="text" class="form-control" name="page_title" id="page_title" required/>
                </div>
            </div>
            <div class="form-group row">
                <label for="description" class="col-2 col-form-label">Description</label>
                <div class="col-9">
                    <textarea class="form-control" name="description" id="description" rows="20" required></textarea>
                </div>
            </div>
            <div class="form-group row">
