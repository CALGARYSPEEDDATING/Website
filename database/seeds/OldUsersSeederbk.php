...
class OldUsersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // \DB::table('dating_profiles')->truncate();
        // \DB::table('event_user')->truncate();
        // \DB::table('users')->truncate();
        // \DB::table(' dating_profiles')->truncate();
        // $path = database_path('seeds/csv/calgary_speed_dating_usersdb.csv'); // MAin
        // $path = database_path('seeds/csv/gjnyhcqzqt2019-04-07users.csv');
        $path = database_path('seeds/csv/unsub_csd.csv');
